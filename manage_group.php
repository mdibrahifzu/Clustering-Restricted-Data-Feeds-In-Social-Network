				...
				<div class="row set0">
					<div class="col-lg-12 col-sm-12 set0">
						...
						<div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="...">
							...
							<div class="btn-group" role="group">
								<a style="background:#ddd;" type="button" id="batch" class="btn btn-default" href="manage_group.php">
									<i class="fa fa-heart-o"></i>
							...
							<div class="btn-group" role="group">
								<a type="button" id="batch" class="btn btn-default" href="batch_posts.php">
									<i class="fa fa-heart-o"></i>
									
									<div class="hidden-xs"> Group Posts </div>
								</a>
							</div>
						</div>
						
						<div class="tab-content" style="margin-top:30px;">
							<?php include_once 'views/profile/manage_group.php'; ?>
						</div>
					</div>
				</div>
		</div>
